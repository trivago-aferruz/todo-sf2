 ...
 * up to version 1358175610.
 * Generated on 2013-01-14 16:00:10 by aferruz
 */
class PropelMigration_1358175610
{
...
ALTER TABLE `task` CHANGE `description` `description` VARCHAR(255) NOT NULL;

CREATE UNIQUE INDEX `task_U_1` ON `task` (`description`);
...
DROP INDEX `task_U_1` ON `task`;

ALTER TABLE `task` CHANGE `description` `description` TEXT NOT NULL;
