...
class StatusTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Todo.TodoBundle.Model.map.StatusTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Todo\\TodoBundle\\Model\\Status');
    ...
    {
        $this->addRelation('Task', 'Todo\\TodoBundle\\Model\\Task', RelationMap::ONE_TO_MANY, array('id' => 'status_id', ), null, null, 'Tasks');
    } // buildRelations()
