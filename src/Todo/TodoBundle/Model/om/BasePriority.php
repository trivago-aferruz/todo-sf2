...
abstract class BasePriority extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Todo\\TodoBundle\\Model\\PriorityPeer';
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = PriorityPeer::NAME;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PriorityPeer::NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PriorityPeer::NAME)) $criteria->add(PriorityPeer::NAME, $this->name);
     ...
     * @return PropelObjectCollection|Task[] List of Task objects
     */
    public function getTasksJoinStatus($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TaskQuery::create(null, $criteria);
     ...
     * @return PropelObjectCollection|Task[] List of Task objects
     */
    public function getTasksJoinreporter($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TaskQuery::create(null, $criteria);
        $query->joinWith('reporter', $join_behavior);
     ...
     * @return PropelObjectCollection|Task[] List of Task objects
     */
    public function getTasksJoinassignee($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TaskQuery::create(null, $criteria);
        $query->joinWith('assignee', $join_behavior);
