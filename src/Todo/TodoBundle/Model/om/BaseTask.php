...
use Todo\TodoBundle\Model\PriorityQuery;
...
abstract class BaseTask extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Todo\\TodoBundle\\Model\\TaskPeer';
    ...
    public function setStatusId($v)
    {
        ...
        if ($this->status_id !== $v) {
            $this->status_id = $v;
            $this->modifiedColumns[] = TaskPeer::STATUS_ID;
        }
    ...
    public function setPriorityId($v)
    {
        ...
        if ($this->priority_id !== $v) {
            $this->priority_id = $v;
            $this->modifiedColumns[] = TaskPeer::PRIORITY_ID;
        }
    ...
    public function setReporterId($v)
    {
        ...
        if ($this->reporter_id !== $v) {
            $this->reporter_id = $v;
            $this->modifiedColumns[] = TaskPeer::REPORTER_ID;
        }

        if ($this->areporter !== null && $this->areporter->getId() !== $v) {
            $this->areporter = null;
        }
    ...
    public function setAssigneeId($v)
    {
        ...
        if ($this->assignee_id !== $v) {
            $this->assignee_id = $v;
            $this->modifiedColumns[] = TaskPeer::ASSIGNEE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->priority_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->reporter_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->assignee_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->areporter !== null && $this->reporter_id !== $this->areporter->getId()) {
            $this->areporter = null;
        }
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->areporter !== null) {
                if ($this->areporter->isModified() || $this->areporter->isNew()) {
                    $affectedRows += $this->areporter->save($con);
                }
                $this->setreporter($this->areporter);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TaskPeer::STATUS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`status_id`';
        }
        if ($this->isColumnModified(TaskPeer::PRIORITY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`priority_id`';
        }
        if ($this->isColumnModified(TaskPeer::REPORTER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`reporter_id`';
        }
        if ($this->isColumnModified(TaskPeer::ASSIGNEE_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`priority_id`':
                        ...
                        break;
                    case '`reporter_id`':
                        $stmt->bindValue($identifier, $this->reporter_id, PDO::PARAM_INT);
                        break;
                    case '`assignee_id`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->areporter !== null) {
                if (!$this->areporter->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->areporter->getValidationFailures());
                }
            }

            if ($this->aassignee !== null) {
                if (!$this->aassignee->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aassignee->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->areporter) {
                $result['reporter'] = $this->areporter->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aassignee) {
                $result['assignee'] = $this->aassignee->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setPriorityId($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setReporterId($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setAssigneeId($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TaskPeer::STATUS_ID)) $criteria->add(TaskPeer::STATUS_ID, $this->status_id);
        if ($this->isColumnModified(TaskPeer::PRIORITY_ID)) $criteria->add(TaskPeer::PRIORITY_ID, $this->priority_id);
        if ($this->isColumnModified(TaskPeer::REPORTER_ID)) $criteria->add(TaskPeer::REPORTER_ID, $this->reporter_id);
        if ($this->isColumnModified(TaskPeer::ASSIGNEE_ID)) $criteria->add(TaskPeer::ASSIGNEE_ID, $this->assignee_id);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setReporterId($this->getReporterId());
     ...
     * @throws PropelException
     */
    public function setreporter(User $v = null)
    {
        if ($v === null) {
        ...
        if ($v !== null) {
            $v->addTaskRelatedByReporterId($this);
        }
     ...
     * @throws PropelException
     */
    public function getreporter(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->areporter === null && ($this->reporter_id !== null) && $doQuery) {
            $this->areporter = UserQuery::create()->findPk($this->reporter_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->areporter->addTasksRelatedByReporterId($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setassignee(User $v = null)
    {
        if ($v === null) {
     ...
     * @throws PropelException
     */
    public function getassignee(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aassignee === null && ($this->assignee_id !== null) && $doQuery) {
            $this->aassignee = UserQuery::create()->findPk($this->assignee_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aassignee->addTasksRelatedByAssigneeId($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->areporter instanceof Persistent) {
              $this->areporter->clearAllReferences($deep);
            }
            if ($this->aassignee instanceof Persistent) {
              $this->aassignee->clearAllReferences($deep);
            }
