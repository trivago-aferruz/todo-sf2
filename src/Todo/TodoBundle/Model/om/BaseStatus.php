...
abstract class BaseStatus extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Todo\\TodoBundle\\Model\\StatusPeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StatusPeer::NAME)) {
     ...
     * @return PropelObjectCollection|Task[] List of Task objects
     */
    public function getTasksJoinPriority($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TaskQuery::create(null, $criteria);
